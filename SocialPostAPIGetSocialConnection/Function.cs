...
namespace ScanPay.Lambda.GetSocialConnection
{
    public class Function :
        BaseLambdaClient
    {
        private const string OperationName =
            "GetSocialConnection::FunctionHandler";
            ...
            ILambdaContext context)
        {
            return await ProxyExecApiAsync<SocialConnectionRequest, object>(
                ...
                action: async normalizedRequest =>
                {
                    ...
                    return await SocialPostOperation.GetConnectionAsync(
                        organizationID,
