...
namespace ScanPay.Lambda.DeleteSocialConnection
{
    public class Function :
        BaseLambdaClient
    {
        private const string OperationName =
            "DeleteSocialConnection::FunctionHandler";

        public async Task<object?> FunctionHandler(
            JObject request,
            ILambdaContext context)
        {
            return await ProxyExecApiAsync<SocialConnectionRequest, object>(
                context: context,
                ...
                action: async normalizedRequest =>
                {
                    ...
                    return await SocialPostOperation.DeleteConnectionAsync(
                        organizationID,
                        normalizedRequest.SocialConnectionID,
                        context);
                },
                correlationID:
                    GetCorrelationID(
                ...
                dataFactory: () =>
                    ...
                    {
                        ["component"] = "DeleteSocialConnection",
