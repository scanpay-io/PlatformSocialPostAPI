...
namespace ScanPay.Lambda.PublishSocialPost
{
    public class Function :
        BaseLambdaClient
    {
        private const string OperationName =
            "PublishSocialPost::FunctionHandler";
            ...
            ILambdaContext context)
        {
            return await ProxyExecApiAsync<SocialPostRequest, object>(
                ...
                action: async normalizedRequest =>
                {
                    ...
                    return await SocialPostOperation.PublishPostAsync(
                        organizationID,
