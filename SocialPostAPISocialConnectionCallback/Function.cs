...
namespace ScanPay.Lambda.SocialConnectionCallback
{
    public class Function :
        BaseLambdaClient
    {
        private const string OperationName =
            "SocialConnectionCallback::FunctionHandler";

        public async Task<object?> FunctionHandler(
            JObject request,
            ILambdaContext context)
        {
            return await ProxyExecApiAsync<SocialConnectionCallbackRequest, object>(
                context: context,
                ...
                action: async normalizedRequest =>
                {
                    ...
                    return await SocialPostOperation.CompleteConnectionCallbackAsync(
                        normalizedRequest,
                        context);
                },
                correlationID:
                ...
                dataFactory: () =>
                    ...
                    {
                        ["component"] = "SocialConnectionCallback",
