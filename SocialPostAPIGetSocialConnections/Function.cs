...
namespace ScanPay.Lambda.GetSocialConnections
{
    public class Function :
        BaseLambdaClient
    {
        private const string OperationName =
            "GetSocialConnections::FunctionHandler";

        public async Task<object?> FunctionHandler(
            JObject request,
            ILambdaContext context)
        {
            return await ProxyExecApiAsync<SocialOrganizationRequest, object>(
                context: context,
                ...
                action: async normalizedRequest =>
                {
                    ...
                    return await SocialPostOperation.GetConnectionsAsync(
                        organizationID,
                        context);
                },
                correlationID:
                ...
                dataFactory: () =>
                    ...
                    {
                        ["component"] = "GetSocialConnections",
